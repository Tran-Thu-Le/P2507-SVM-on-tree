...
# from svm_on_tree_cpp import fit_core_lambda_any  # C++ core
...
#     out = fit_core_lambda_any(X, y, lam)
...
# from svm_on_tree_cpp import fit_core_lambda_any  # C++ core: trả về t_dpdfs (DFS+DP only)
...
from svm_on_tree_cpp import fit_core_lambda_any  # C++ core (đã đo t_dpdfs & t_pairs)
