...
The remainder of this paper is organized as follows: Section~\ref{sec:classical_svm} reviews the foundations of classical SVM theory, Section~\ref{sec:svm_tree} presents our SVM on Tree methodology, Section~\ref{sec:experiments} provides experimental validation, and Section~\ref{sec:conclusion} concludes with directions for future work.
