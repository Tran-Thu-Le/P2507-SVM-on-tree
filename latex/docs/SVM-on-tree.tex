...
Therefore,
\begin{align}
L_1 &= L(s,p_1) = f(s,p_1) - d(s,p_1), \\
L_2 &= L(s,p_2) = f(s,p_2) - d(s,p_2).
\end{align}

Substituting gives
\begin{align}
L_1 &= f(s,p_2) - d(s,p_2) + n'(p_1,s)\cdot y + d(p_2,p_3) + y, \\
L_2 &= f(s,p_2) - d(s,p_2).
\end{align}

Thus,
\[
L_1 = L_2 + n'(p_1,s)\cdot y + d(p_2,p_3) + y.
\]

Since $n'(p_1,s)\cdot y \ge 0$, $d(p_2,p_3) \ge 0$, and $y > 0$, it follows that
\[
L_1 > L_2.
\]
