...
\begin{proof}
    ...
    \remHUAN{Huan will prove this part. Le thinks that we can move the proof of the corresponding result when $\lambda=1$ to this part with a suitable proof modification.}
\end{proof}
